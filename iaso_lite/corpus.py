...
Verbatim port of iaso-ptsd-agent/iaso/corpus.py. The index is a lazily-built
...
def build_index(cfg: Settings | None = None, *, force: bool = False) -> EvidenceIndex:
    ...
    if not pdf_paths:
        raise FileNotFoundError(
            f"No .pdf/.txt files under {cfg.evidence_dir}. Set IASO_EVIDENCE_DIR to the corpus folder."
        )
