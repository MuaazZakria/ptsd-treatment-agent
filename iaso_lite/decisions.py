...
Ported from iaso-ptsd-agent/iaso/decisions.py. Every decision is written as
...
The client sends the draft/audit it is deciding on (iaso-manus has no
server-side run cache in this pass - see HANDOVER.md's deferred "run
persistence" item) so the record is self-contained: what was drafted, what
